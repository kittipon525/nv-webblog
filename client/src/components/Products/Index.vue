<template>
 ...
 <div>
 <button class="btn btn-outline-success" v-on:click="navigateTo('/product/create')">สร้าง
รายการ</button>
 ...
 *** ไม่มีข้อมูล***
 ...
 <h3>{{ product.name }}</h3>
 <p><strong>ยี่ห้อ:</strong> {{ product.taste }}</p>
...
.blog-list {
 ...
 margin-right: auto;
 padding: 5px;
 box-shadow: 0 2px 4px 0 rgb(182, 177, 177);
}
.blog-header {
 max-width: 900px;
 margin-left: auto;
